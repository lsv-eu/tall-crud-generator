    ...
    <x-slot name="content">
        <div class="mt-4">
            <div>
                ...
                <x-tall-crud-select class="block mt-1 w-1/2" wire:model.blur="belongsToManyRelation.name">
...
<x-tall-crud-dialog-modal wire:model.live="confirmingBelongsTo">
    ...
    <x-slot name="content">
        <div class="mt-4">
            <div>
                <x-tall-crud-label>Select Relationship</x-tall-crud-label>
                <x-tall-crud-select class="block mt-1 w-1/2" wire:model.blur="belongsToRelation.name">
                    <option value="">-Please Select-</option>
...
<x-tall-crud-dialog-modal wire:model.live="confirmingWith">
    ...
    <x-slot name="content">
        <div class="mt-4">
            <div>
                <x-tall-crud-label>Select Relationship</x-tall-crud-label>
                <x-tall-crud-select class="block mt-1 w-1/2" wire:model.blur="withRelation.name">
                    <option value="">-Please Select-</option>
...
<x-tall-crud-dialog-modal wire:model.live="confirmingWithCount">
    ...
    <x-slot name="content">
        <div class="mt-4">
            <div>
                <x-tall-crud-label>Select Relationship</x-tall-crud-label>
                <x-tall-crud-select class="block mt-1 w-1/2" wire:model.blur="withCountRelation.name">
                    <option value="">-Please Select-</option>
                    @foreach ($allRelations as $allRelation)
                    @foreach ($allRelation as $c)
                    <option value="{{$c['name']}}">{{$c['name']}}</option>
